...
const _sfc_main$1 = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<aside${serverRenderer_cjs_prodExports.ssrRenderAttrs(vueExports.mergeProps({ class: "sidebar" }, _attrs))} data-v-28e47f63><div class="sidebar-brand" data-v-28e47f63><span class="sidebar-brand__logo" data-v-28e47f63>T</span><span class="sidebar-brand__name" data-v-28e47f63>rimly</span></div><nav class="sidebar-nav" data-v-28e47f63><!--[-->`);
          ...
          default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (link.icon === "overview") {
                _push2(`<svg class="nav-icon" viewBox="0 0 16 16" fill="none" data-v-28e47f63${_scopeId}><rect x="1" y="1" width="6" height="6" rx="1.5" stroke="currentColor" stroke-width="1.5" data-v-28e47f63${_scopeId}></rect><rect x="9" y="1" width="6" height="6" rx="1.5" stroke="currentColor" stroke-width="1.5" data-v-28e47f63${_scopeId}></rect><rect x="1" y="9" width="6" height="6" rx="1.5" stroke="currentColor" stroke-width="1.5" data-v-28e47f63${_scopeId}></rect><rect x="9" y="9" width="6" height="6" rx="1.5" stroke="currentColor" stroke-width="1.5" data-v-28e47f63${_scopeId}></rect></svg>`);
              } else {
                _push2(`<!---->`);
              }
              if (link.icon === "events") {
                _push2(`<svg class="nav-icon" viewBox="0 0 16 16" fill="none" data-v-28e47f63${_scopeId}><path d="M2 4h12M2 8h8M2 12h10" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" data-v-28e47f63${_scopeId}></path></svg>`);
              } else {
                _push2(`<!---->`);
              }
              if (link.icon === "settings") {
                _push2(`<svg class="nav-icon" viewBox="0 0 16 16" fill="none" data-v-28e47f63${_scopeId}><circle cx="8" cy="8" r="2.5" stroke="currentColor" stroke-width="1.5" data-v-28e47f63${_scopeId}></circle><path d="M8 1.5v1.8M8 12.7v1.8M1.5 8h1.8M12.7 8h1.8M3.2 3.2l1.3 1.3M11.5 11.5l1.3 1.3M3.2 12.8l1.3-1.3M11.5 4.5l1.3-1.3" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" data-v-28e47f63${_scopeId}></path></svg>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<span data-v-28e47f63${_scopeId}>${serverRenderer_cjs_prodExports.ssrInterpolate(link.label)}</span>`);
            } else {
              return [
      ...
      _push(`<!--]--></nav><div class="sidebar-footer" data-v-28e47f63>`);
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_BaseLangSwitcher, null, null, _parent));
      _push(`<span class="sidebar-version" data-v-28e47f63>v0.1.0</span></div></aside>`);
    };
  }
});
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-28e47f63"]]);
const _sfc_main = {};
...
//# sourceMappingURL=default-DqmjJCuE.mjs.map
