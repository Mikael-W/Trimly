import { v as vueExports, f as fetchDefaults, g as useNuxtApp, a as asyncDataDefaults, i as useRequestFetch, r as requireShared_cjs_prod, c as createError } from './server.mjs';
...
function createAsyncData(nuxtApp, key, _handler, options, initialCachedData) {
  ...
  const asyncData = {
    ...
    pending: vueExports.shallowRef(!hasCachedData),
...
function useFetch(request, arg1, arg2) {
  ...
  if (!immediate) {
    ...
    vueExports.watch(key, setImmediate, { flush: "sync", once: true });
    vueExports.watch([...watchSources || [], _fetchOptions], setImmediate, { flush: "sync", once: true });
  }
