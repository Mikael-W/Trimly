...
export const FR_FILLER_PATTERNS: FillerPattern[] = [
  ...
  { id: 'fr-hope-well', pattern: /j'esp[eè]re (sincèrement |vraiment )?(que tu vas|que vous allez)[^.!?]*[.!?]?\s*/gi, replace: '' },
  { id: 'fr-would-possible', pattern: /\bserait[- ]il possible (de bien vouloir |de )?\b/gi, replace: '' },
  ...
  { id: 'fr-absolutely-ask', pattern: /\bje voulais (absolument |vraiment )?te demander (quelque chose )?\b/gi, replace: '' },
  { id: 'fr-no-bother', pattern: /,?\s*si (ça|cela) ne te d[eé]range (vraiment )?pas trop\.?\s*/gi, replace: ' ' },
  { id: 'fr-what-i-want', pattern: /\bce que je cherche [àa] faire,?\s*(c'est )?\b/gi, replace: '' },
  { id: 'fr-essentially', pattern: /\bc'est essentiellement\b/gi, replace: "c'est" },
  { id: 'fr-very-useful', pattern: /\bce serait (vraiment )?(super|très) (utile|pratique|sympa)\b/gi, replace: '' },
  { id: 'fr-quite-loaded', pattern: /\b(sincèrement|absolument|vraiment|essentiellement)\b/gi, replace: '' },
